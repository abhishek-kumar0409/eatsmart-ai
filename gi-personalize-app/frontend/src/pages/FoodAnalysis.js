...
const FoodAnalysis = ({ user }) => {
  ...
  const handleLogResponse = async (mealId, response) => {
    try {
      await axios.post(`/api/meals/${user.user_id}/${mealId}/response`, {
        response: response
      });
        ...
        <div className="analysis-results">
          ...
          <div className="feedback-section">
            ...
            <div className="feedback-buttons">
              <button 
                onClick={() => handleLogResponse(results.meal_id, 'less_than_expected')}
                className="btn btn-secondary feedback-button"
              >
                Less impact than expected
              </button>
              <button 
                onClick={() => handleLogResponse(results.meal_id, 'as_expected')}
                className="btn btn-secondary feedback-button"
              >
                As expected
              </button>
              <button 
                onClick={() => handleLogResponse(results.meal_id, 'more_than_expected')}
                className="btn btn-secondary feedback-button"
              >
